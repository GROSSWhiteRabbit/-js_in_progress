...
function calcCalory() {
  ...
  if (localStorage.getItem('gender')) {
    ...
    setActiveChoose(document.querySelector("#".concat(localStorage.getItem('gender'))));
  } else {
  ...
  if (localStorage.getItem('physicalActivity')) {
    ...
    setActiveChoose(document.querySelector("[data-ratio=\"".concat(localStorage.getItem('physicalActivity'), "\"]")));
  } else {
  ...
  function getDinamicInformation(elemSelector) {
    document.querySelector(elemSelector).addEventListener('input', function (e) {
      ...
      if (!timerMasha) {
        timerMasha = setTimeout(function () {
  ...
  function setActiveChoose(elem) {
    _toConsumableArray(elem.parentNode.children).forEach(function (item) {
      return item.classList.remove('calculating__choose-item_active');
    });
  ...
  function lisenActiveChoose(elemSelector) {
    document.querySelector(elemSelector).addEventListener('click', function (e) {
...
function cards() {
  var MenuCard = /*#__PURE__*/function () {
    function MenuCard(img, alt, tittle, desc, price, parentSelector) {
...
function forms(formsSelector, modalTimerId) {
  ...
  function BindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      'server.php', json).then(function (resp) {
        ...
        return showThenksModal(massage.failure);
      }).finally(function () {
        form.reset();
  ...
  function showThenksModal(massage) {
    ...
    Object(_modal__WEBPACK_IMPORTED_MODULE_8__["showModal"])('.modal');
    var thenksModal = document.createElement('div');
...
function showModal(modalSelector, modalTimerId) {
  var element = document.querySelector(modalSelector);
...
function modal(modalSelector, btnsOpenModalSelector, modalTimerId) {
  var btns = document.querySelectorAll(btnsOpenModalSelector),
...
function slider(_ref) {
  var sliderSelector = _ref.sliderSelector,
      ...
      sledesSelector = _ref.sledesSelector,
  ...
  var slideTimer = setInterval(shiftLeft, 3000);
  ...
  function shiftToSlide(i) {
    ...
    indexVisi = i;
    сurrent.textContent = Object(_services_services__WEBPACK_IMPORTED_MODULE_4__["getZero"])(indexVisi);
  ...
  function startSlider() {
    listenSwitchesSlider();
    total.textContent = Object(_services_services__WEBPACK_IMPORTED_MODULE_4__["getZero"])(slides.length);
    сurrent.textContent = Object(_services_services__WEBPACK_IMPORTED_MODULE_4__["getZero"])(1);
    setActiveDot(indexVisi);
  }
}
...
function timer(id, deadline) {
  function getTimeRemaining(strOrYear, month, days) {
    ...
    var deadline = typeof strOrYear == 'string' ? new Date(strOrYear) : new Date(strOrYear, month, days, hours, minutes, seconds),
    ...
    var daysN = Math.floor(TimeRemaining.getTime() / 1000 / 60 / 60 / 24); // const t = Date.parse(endtime) - Date.parse(new Date()),
  ...
  function setClock(id, strOrYear, month, days) {
    ...
    var timerId = document.querySelector(id);
    var daysElem = timerId.querySelector('#days');
    var hoursElem = timerId.querySelector('#hours');
    var minutesElem = timerId.querySelector('#minutes');
    var secondsElem = timerId.querySelector('#seconds');
    var timer = setInterval(updateClock, 1000);
    updateClock();

    function updateClock() {
      var TimeRemainingObj = getTimeRemaining(strOrYear, month, days, hours, minutes, seconds);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_0__["default"])('.timer', '2021-05-20');
